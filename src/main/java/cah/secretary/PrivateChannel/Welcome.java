...
public class Welcome extends ListenerAdapter {
    ...
    public void onGuildMemberJoin​(GuildMemberJoinEvent event) {
        ...
        channel.sendMessage("Welcome to the College Admissions Hub server, " + event.getMember().getAsMention() +
                "! This is the " + event.getMember().getDefaultChannel().getAsMention() + " channel.  \n" +
                ...
                "Once you have completed the quiz, you should be able to type in this channel. Please give " +
                ...
                "command \".derole\" followed by the role you want to remove.").queue();
